...
using Luminus.Selenium.specs.Shared.StDetalharAplicativoEaePSTabela16940;

namespace Luminus.Selenium.specs.Shared.StDetalharAplicativoEaePSTabela16940
{
    public class StDetalharAplicativoEaePSTabela16940PageStep
    {
        ...
        [Step("ST - Detalhar aplicativo EAE/P/S <tabela> [16940]")]
        public void StDetalharAplicativoEaePS16940(Table tabela)
        {
